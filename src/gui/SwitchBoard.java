...
public final class SwitchBoard {
	...
	public void createLayout() {
		...
		components.add(new Line(5, CY+3, 106, CY+3, 0.8, Color.BLACK));
		components.add(new Line(0, CY+3+5, 5, CY+3, 0.8, Color.BLACK));
		
		// Crossover at the left
		components.add(new Line(6, CY, 6 + 3, CY + 3, 3/2f, 0, 0.5, Color.BLACK));
		components.add(new SingleLED(9, CY, EAST, new Label("D1",0,-2)));
		components.add(new SingleLED(8, CY+1, NORTH, new Label("D2",0,-2)));
		components.add(new SingleLED(6, CY+3, EAST, new Label("D3",0,-2)));
		components.add(new Button(5, CY, EAST, new Label("S1",0,-2)));
		
		// Crossover little right
		components.add(new Line(25, CY, 25 - 3, CY + 3, 3/2f, 0, 0.5, Color.BLACK));
		components.add(new SingleLED(22, CY, EAST, new Label("D4",0,-2)));
		components.add(new SingleLED(24, CY+1, NORTH, new Label("D5",0,-2)));
		components.add(new SingleLED(25, CY+3, EAST, new Label("D6",0,-2)));
		components.add(new Button(26, CY, EAST, new Label("S2",0,-2)));
		
		// Siding for storage of passenger cars
		components.add(new Line(12, CY, 12 + 3, CY - 3, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new Line(15, CY - 3, 29, CY - 3, SPACING/2f, 0, 0.5, Color.BLACK));
		...
		components.add(new Line(29, CY - 3, 29 + 3, CY, SPACING/2f, 0, 0.5, Color.BLACK));
		...
		components.add(new Line(20, CY - 3, 20 - 3, CY - 3*2, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new Line(17, CY - 3*2, 10, CY - 3*2, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new SingleLED(17, CY - 3, EAST, new Label("D11",0,-2)));
		components.add(new SingleLED(18, CY - 3 - 2, EAST, new Label("D12",0,-2)));
		components.add(new Button(20, CY - 3, EAST, new Label("S5",0,-2)));
		
		// Siding to the right from the above siding
		components.add(new Line(24, CY - 3, 24 + 3, CY - 3*2, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new Line(27, CY - 3*2, 40, CY - 3*2, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new SingleLED(27, CY - 3, EAST, new Label("D13",0,-2)));
		components.add(new SingleLED(26, CY - 3 - 2, EAST, new Label("D14",0,-2)));
		components.add(new Button(24, CY - 3, EAST, new Label("S6",0,-2)));
		...
		components.add(new SingleLED(29+1, CY, EAST, new Label("D19",0,-2)));
		components.add(new SingleLED(30+1, CY-2, EAST, new Label("D20",0,-2)));
		components.add(new Button(32+1, CY, EAST, new Label("S9",0,-2)));
		...
		components.add(new Text(49, CY+3, Orientation.EAST, new Label("5",0,0,5,true)));
		components.add(new Text(49, CY+7, Orientation.EAST, new Label("6",0,0,5,true)));
		components.add(new Text(49, CY+11, Orientation.EAST, new Label("7",0,0,5,true)));
		components.add(new Text(49, CY+14, Orientation.EAST, new Label("8",0,0,5,true)));
...
*/		
		...
		// Siding for cabooses
		components.add(new Line(17, CY + 3, 17 + 3, CY + 3*2, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new Line(20, CY + 3*2, 34, CY + 3*2, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new SingleLED(20, CY + 3, EAST, new Label("D101",0,-2)));
		components.add(new SingleLED(19, CY + 3 + 2, EAST, new Label("D102",0,-2)));
		components.add(new Button(17, CY + 3, EAST, new Label("S101",0,-2)));
		
		// Siding for engines
		components.add(new Line(32, CY + 3*2, 32 - 3, CY + 3*3, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new Line(20, CY + 3*3, 34, CY + 3*3, SPACING/2f, 0, 0.5, Color.BLACK));
		components.add(new SingleLED(20, CY + 3*2, EAST, new Label("D103",0,-2)));
		components.add(new SingleLED(19, CY + 3*2 + 2, EAST, new Label("D104",0,-2)));
		components.add(new Button(17, CY + 3*2, EAST, new Label("S102",0,-2)));
	}
