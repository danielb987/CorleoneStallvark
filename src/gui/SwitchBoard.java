...
import electric.SingleLED.LED_Color;
...
//		components.add(new Line(0, CY, 106, CY, 1, Color.BLACK));
		...
		// Main track on freight yard
		componentsTopSide.add(new Line(4, CY+4, 79.5, CY+4, 0.8, Color.BLACK));
		componentsTopSide.add(new Line(0, CY+8, 4, CY+4, 0.8, Color.BLACK));
//		componentsTopSide.add(new Line(79, CY+4, 84, CY+9, 3/2f, 0, 0.8, Color.BLACK));
		componentsTopSide.add(new Line(79.5, CY+4, 84, CY+8.5, 0.8, Color.BLACK));
		componentsTopSide.add(new Line(84, CY+8.5, 84, 39, 0.8, Color.BLACK));
...
//		componentsLeftSide.add(new SingleLED(5, CY+4, EAST, new Label("D3",0,-2)));
		...
		// Crossover little right
		componentsTopSide.add(new Line(25, CY, 25 - 4, CY + 4, 3/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(23, CY-3, EAST, new Label("D4",0,-2), LED_Color.GREEN));
//		componentsLeftSide.add(new SingleLED(23, CY+2, EAST, new Label("D5",0,-2)));
//		componentsLeftSide.add(new SingleLED(24, CY+4, EAST, new Label("D6",0,-2)));
		componentsLeftSide.add(new Button(18, CY-3, EAST, new Label("S2",0,-2)));
...
//		components.add(new Button(25, CY, EAST, new Label("S2+",0,-2)));
		componentsLeftSide.add(new Button(88, CY+5, NORTH, new Label("S201",0,-2)));
...
//		components.add(new Button(4, CY, EAST, new Label("S1+",0,-2)));
		...
		componentsLeftSide.add(new SingleLED(68, CY, EAST, new Label("D205",0,-2), LED_Color.GREEN));
		componentsLeftSide.add(new Button(65, CY, EAST, new Label("S202*",0,-2)));
		componentsLeftSide.add(new SingleLED(74, CY+4, EAST, new Label("D205*",0,-2), LED_Color.YELLOW));
		componentsLeftSide.add(new Button(71, CY+4, EAST, new Label("S202**",0,-2)));
		
		// Crossover vertical 1
		componentsTopSide.add(new Line(84, CY+9-1, 88, CY+13-1, 0, 3/2f, 0.5, Color.BLACK));
//		componentsLeftSide.add(new SingleLED(88, CY+10, NORTH, new Label("D207",3,0), LED_Color.RED));
//		componentsLeftSide.add(new SingleLED(86, CY+11, NORTH, new Label("D208",0,-3), LED_Color.RED));
//		componentsLeftSide.add(new SingleLED(84, CY+12, NORTH, new Label("D209",-3,0), LED_Color.RED));
//		components.add(new Button(4, CY, EAST, new Label("S1+",0,-2)));
		componentsLeftSide.add(new Button(84, CY+22, NORTH, new Label("S203",3,0)));
...
//		componentsLeftSide.add(new SingleLED(12, CY-2, EAST, new Label("D8",0,-2)));
		...
		componentsTopSide.add(new Line(28, CY - 3, 31, CY, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(19, CY, EAST, new Label("D9",0,-2), LED_Color.GREEN));
//		componentsLeftSide.add(new SingleLED(29, CY-2, EAST, new Label("D10",0,-2)));
		componentsLeftSide.add(new Button(16, CY, EAST, new Label("S4",0,-2)));
		componentsTopSide.add(new Text(20.5, CY-3, Orientation.EAST, new Label("11",0,0,180,4,true)));
		...
		if (SUPPORT_SMALL_SIDINGS) {
			...
			// Siding to the left from the above siding
			componentsTopSide.add(new Line(16, CY - 3, 13, CY - 6, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsTopSide.add(new Line(13, CY - 6, 6, CY - 6, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsTopSide.add(new Text(9.5, CY-6, Orientation.EAST, new Label("12",0,0,180,4,true)));

			// Siding to the right from the above siding
			componentsTopSide.add(new Line(25, CY - 3, 28, CY - 6, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsTopSide.add(new Line(28, CY - 6, 38, CY - 6, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsTopSide.add(new Text(34, CY-6, Orientation.EAST, new Label("13",0,0,180,4,true)));

			// Siding to the right from the above siding
			componentsTopSide.add(new Line(28, CY - 6, 28 + 3, CY - 9, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsTopSide.add(new Line(31, CY - 9, 38, CY - 9, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsTopSide.add(new Text(34, CY-9, Orientation.EAST, new Label("14",0,0,180,4,true)));
		}
...
//		componentsLeftSide.add(new SingleLED(44, CY, EAST, new Label("D23",0,-2)));
//		componentsLeftSide.add(new SingleLED(43, CY-2, EAST, new Label("D24",0,-2)));
		componentsLeftSide.add(new Button(47, CY, EAST, new Label("S11",0,-2)));
		componentsTopSide.add(new Line(60, CY - 4, 64, CY, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(52, CY, EAST, new Label("D25",0,-2), LED_Color.GREEN));
//		componentsLeftSide.add(new SingleLED(62, CY-2, EAST, new Label("D26",0,-2)));
		componentsLeftSide.add(new Button(47, CY-11, EAST, new Label("S12",0,-2)));
		componentsTopSide.add(new Text(49.5, CY-4, Orientation.EAST, new Label("3",0,0,180,4,true)));
		
		// Passenger track 2
		componentsTopSide.add(new Line(35, CY, 43, CY - 8, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsTopSide.add(new Line(43, CY - 8, 56, CY - 8, SPACING/2f, 0, 0.5, Color.BLACK));
//		componentsLeftSide.add(new SingleLED(38, CY, EAST, new Label("D17",0,-2)));
		componentsLeftSide.add(new SingleLED(41, CY-6, EAST, new Label("D18",0,-2), LED_Color.GREEN));
		componentsLeftSide.add(new Button(39, CY-4, EAST, new Label("S8*",0,-2)));
		componentsLeftSide.add(new Button(47, CY-4, EAST, new Label("S8",0,-2)));
		componentsTopSide.add(new Line(56, CY - 8, 60, CY - 4, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsTopSide.add(new Text(49.5, CY-8, Orientation.EAST, new Label("2",0,0,180,4,true)));
		
		// Engine storage track
		componentsTopSide.add(new Line(58, CY - 6, 68, CY - 6, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(66, CY-6, EAST, new Label("D27",0,-2), LED_Color.GREEN));
//		componentsLeftSide.add(new SingleLED(58, CY-8+2, EAST, new Label("D28",0,-2)));
		componentsLeftSide.add(new SingleLED(52, CY-4, EAST, new Label("D29",0,-2), LED_Color.GREEN));
		componentsLeftSide.add(new Button(60, CY-6, EAST, new Label("S10",0,-2)));
		componentsTopSide.add(new Text(63, CY-6, Orientation.EAST, new Label("21",0,0,180,4,true)));
...
//		componentsLeftSide.add(new SingleLED(46, CY-8, EAST, new Label("D19",0,-2)));
//		componentsLeftSide.add(new SingleLED(45, CY-8-2, EAST, new Label("D20",0,-2)));
		componentsLeftSide.add(new Button(47, CY-8, EAST, new Label("S9",0,-2)));
		componentsTopSide.add(new Line(53, CY-11, 56, CY-8, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(52, CY-8, EAST, new Label("D21",0,-2), LED_Color.GREEN));
		componentsLeftSide.add(new SingleLED(52, CY-11, EAST, new Label("D22",0,-2), LED_Color.GREEN));
		componentsTopSide.add(new Text(49.5, CY-11, Orientation.EAST, new Label("1",0,0,180,4,true)));
		
		componentsTopSide.add(new Text(49.5, CY, Orientation.EAST, new Label("4",0,0,180,4,true)));
		componentsTopSide.add(new Text(49.5, CY+4, Orientation.EAST, new Label("5",0,0,4,true)));
//		components.add(new Text(48, CY+8, Orientation.EAST, new Label("6",0,0,4,true)));
//		components.add(new Text(48, CY+12, Orientation.EAST, new Label("7",0,0,4,true)));
//		components.add(new Text(48, CY+15, Orientation.EAST, new Label("8",0,0,4,true)));
...
//			componentsLeftSide.add(new SingleLED(18, CY + 4 + 2, EAST, new Label("D102",0,-2)));
			componentsLeftSide.add(new Button(14, CY + 4, EAST, new Label("S101",0,-2)));
			componentsTopSide.add(new Line(31, CY + 4, 28, CY + 7, SPACING/2f, 0, 0.5, Color.BLACK));
			componentsLeftSide.add(new SingleLED(29, CY + 4, EAST, new Label("D103",0,-2), LED_Color.YELLOW));
			componentsLeftSide.add(new SingleLED(26, CY + 7, EAST, new Label("D103*",0,-2), LED_Color.YELLOW));
//			componentsLeftSide.add(new SingleLED(29, CY + 4 + 2, EAST, new Label("D104",0,-2)));
			componentsLeftSide.add(new Button(26, CY + 4, EAST, new Label("S102",0,-2)));
			componentsLeftSide.add(new Button(22, CY + 7, EAST, new Label("S13",0,-2)));
			componentsTopSide.add(new Text(24, CY+7, Orientation.EAST, new Label("15",0,0,4,true)));
...
//		componentsLeftSide.add(new SingleLED(38, CY + 4, EAST, new Label("D51",0,-2)));
//		componentsLeftSide.add(new SingleLED(37, CY + 4 + 2, EAST, new Label("D52",0,-2)));
		componentsLeftSide.add(new Button(47, CY + 4, EAST, new Label("S51",0,-2)));
		componentsTopSide.add(new Line(64, CY + 4, 60, CY + 8, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(52, CY + 4, EAST, new Label("D53",0,-2), LED_Color.YELLOW));
//		componentsLeftSide.add(new SingleLED(62, CY + 4 + 2, EAST, new Label("D54",0,-2)));
//		componentsLeftSide.add(new Button(64, CY + 4, EAST, new Label("S52",0,-2)));
		componentsTopSide.add(new Text(49.5, CY+8, Orientation.EAST, new Label("6",0,0,4,true)));
...
//		componentsLeftSide.add(new SingleLED(42, CY + 8, EAST, new Label("D55",0,-2)));
//		componentsLeftSide.add(new SingleLED(41, CY + 8 + 2, EAST, new Label("D56",0,-2)));
		componentsLeftSide.add(new Button(47, CY + 8, EAST, new Label("S53",0,-2)));
		componentsTopSide.add(new Line(60, CY + 8, 56, CY + 12, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(52, CY + 8, EAST, new Label("D57",0,-2), LED_Color.YELLOW));
//		componentsLeftSide.add(new SingleLED(58, CY + 8 + 2, EAST, new Label("D58",0,-2)));
//		componentsLeftSide.add(new Button(60, CY + 8, EAST, new Label("S54",0,-2)));
		componentsTopSide.add(new Text(49.5, CY+12, Orientation.EAST, new Label("7",0,0,4,true)));
...
//		componentsLeftSide.add(new SingleLED(46, CY + 12, EAST, new Label("D59",0,-2)));
//		componentsLeftSide.add(new SingleLED(45, CY + 12 + 2, EAST, new Label("D60",0,-2)));
		componentsLeftSide.add(new Button(47, CY + 12, EAST, new Label("S55",0,-2)));
		componentsTopSide.add(new Line(56, CY + 12, 53, CY + 15, SPACING/2f, 0, 0.5, Color.BLACK));
		componentsLeftSide.add(new SingleLED(52, CY + 12, EAST, new Label("D61",0,-2), LED_Color.YELLOW));
		componentsLeftSide.add(new SingleLED(52, CY + 15, EAST, new Label("D62",0,-2), LED_Color.YELLOW));
		componentsLeftSide.add(new Button(47, CY + 15, EAST, new Label("S56",0,-2)));
		componentsTopSide.add(new Text(49.5, CY+15, Orientation.EAST, new Label("8",0,0,4,true)));
